...
const navItems = [
  ...
  { href: '/ai-assistant', icon: Bot, label: 'AI-ассистент' },
  { href: '/symptom-journal', icon: BookHeart, label: 'Журнал симптомов' },
  { href: '/triage', icon: HeartPulse, label: 'Triage-анализ' },
  { href: '/education', icon: GraduationCap, label: 'Обучение' },
  { href: '/contacts', icon: MessageSquare, label: 'Контакты' },
  { href: '/iot-monitor', icon: Thermometer, label: 'IoT Монитор' },
];
        ...
        <header className="flex h-14 items-center justify-between border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 px-4 md:pl-0">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-xl font-semibold font-headline">
              {navItems.find(item => item.href === pathname)?.label || 'PeriBloom'}
            </h1>
          </div>
        </header>
